...
![自定义图标](/src/main/resources/base/media/custom-icon.gif)
...
![自定义尺寸](/src/main/resources/base/media/custom-size.gif)
...
![自定义内容](/src/main/resources/base/media/custom-content.gif)
